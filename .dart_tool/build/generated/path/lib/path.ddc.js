define(['dart_sdk'], function(dart_sdk) {
  ...
  const src__path_set = Object.create(_root);
  const src__path_map = Object.create(_root);
  ...
  const src__characters = Object.create(_root);
