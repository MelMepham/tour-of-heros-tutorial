      ...
      if (!dart.test(when)) {
        ...
        if (onError != null) {
          newOnError = dart.fn((error, stackTrace) => {
            onError(error, stackTrace == null ? src__chain.Chain.current() : src__chain.Chain.forTrace(core.StackTrace._check(stackTrace)));
