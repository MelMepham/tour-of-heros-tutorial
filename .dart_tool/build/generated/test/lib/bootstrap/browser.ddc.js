define(['dart_sdk', 'packages/stream_channel/stream_channel', 'packages/test/src/runner/plugin/remote_platform_helpers', 'packages/test/src/backend/closed_exception'], function(dart_sdk, stream_channel, remote_platform_helpers, closed_exception) {
  'use strict';
  ...
  src__bootstrap__browser.internalBootstrapBrowserTest = function(getMain) {
    let channel = src__runner__plugin__remote_platform_helpers.serializeSuite(getMain, {hidePrints: false, beforeLoad: dart.fn(() => async.async(core.Null, function*() {
        ...
        src__runner__plugin__remote_platform_helpers.setStackTraceMapper(src__util__stack_trace_mapper.StackTraceMapper.deserialize(serialized));
      }), VoidToFutureOfNull())});
  ...
  }, '{"version":3,"sourceRoot":"","sources":["../src/runner/browser/post_message_channel.dart","../src/bootstrap/browser.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;AAoBE,QAAI,aAAa,IAAI,0DAAuB,QAAO;AAEnD,eAAM,YAAU,OAAO,CAAC,QAAC,OAAO;AAK9B,UAAI,OAAO,OAAO,IAAI,WAAM,WAAS,SAAO,EAAE;AAC9C,aAAO,gBAAgB;AAEvB,gBAAU,MAAM,KAAK,IAAI,CAAC,OAAO,OAAK;;AAGxC,cAAU,MAAM,OAAO,OAAO,CAAC,QAAC,IAAI;AAGlC,2CAAkB,CAAC,aAAK,CAAC,0CAAC,QAAQ,WAAM,WAAS,KAAK,EAAE,QAAQ,IAAI,KAChE,WAAM,WAAS,SAAO;;AAK5B,yCAAkB,CAAC,aAAK,CAAC,yCAAC,QAAQ,WAAM,WAAS,KAAK,EAAE,SAAS,SAC7D,WAAM,WAAS,SAAO;AAE1B,UAAO,WAAU,QAAQ;EAC3B;kEClCkC,OAAkB;AAClD,QAAI,UACA,2DAAc,CAAC,OAAO,eAAc,mBAAmB;AACzD,YAAI,yBACA,MAAM,yDAAY,CAAC,6BAA6B,MAAM;AAC1D,YAAI,UAAU,IAAI,MAAM;AACxB,wEAAmB,CAAC,8CAAgB,YAAY,CAAC,UAAU;MAC7D;AACA,iEAAkB,OAAO,CAAC,OAAO;EACnC","file":"browser.ddc.js"}');
  // Exports:
  return {
