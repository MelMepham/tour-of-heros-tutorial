define(['dart_sdk', 'packages/angular_app/src/hero'], function(dart_sdk, hero) {
  ...
  dart.trackLibraries("packages/angular_app/src/mock_heroes.ddc", {
    "package:angular_app/src/mock_heroes.dart": src__mock_heroes
  }, '{"version":3,"sourceRoot":"","sources":["mock_heroes.dart"],"names":[],"mappings":";;;;;;;;;;;MAEM,2BAAU;YAAG,yBACjB,kBAAI,CAAC,IAAI,iBACT,kBAAI,CAAC,IAAI,cACT,kBAAI,CAAC,IAAI,iBACT,kBAAI,CAAC,IAAI,kBACT,kBAAI,CAAC,IAAI,gBACT,kBAAI,CAAC,IAAI,kBACT,kBAAI,CAAC,IAAI,eACT,kBAAI,CAAC,IAAI,cACT,kBAAI,CAAC,IAAI,cACT,kBAAI,CAAC,IAAI","file":"mock_heroes.ddc.js"}');
  // Exports:
  return {
