...
import 'package:angular_app/in_memory_data_service.template.dart' as _ref3;
...
import 'package:angular_app/in_memory_data_service.dart' as _i3;
...
class _Injector$injector extends _i2.HierarchicalInjector {
  ...
  _i4.HashLocationStrategy _getHashLocationStrategy$1() => _field1 ??= new _i4.HashLocationStrategy(inject(_i8.PlatformLocation), injectOptionalUntyped(const _i9.OpaqueToken<String>('appBaseHref'), null));
  ...
  _i7.RouterImpl _getRouterImpl$4() => _field4 ??= new _i7.RouterImpl(inject(_i6.Location), injectOptionalUntyped(_i11.RouterHook, null));
