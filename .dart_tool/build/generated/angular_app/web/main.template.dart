...
class _Injector$injector extends _i2.HierarchicalInjector {
  ...
  _i3.HashLocationStrategy _getHashLocationStrategy$0() => _field0 ??= new _i3.HashLocationStrategy(inject(_i7.PlatformLocation), injectOptionalUntyped(const _i8.OpaqueToken<String>('appBaseHref'), null));
  ...
  _i6.RouterImpl _getRouterImpl$3() => _field3 ??= new _i6.RouterImpl(inject(_i5.Location), injectOptionalUntyped(_i10.RouterHook, null));
