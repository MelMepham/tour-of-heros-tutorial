define(['dart_sdk', 'packages/intl/src/plural_rules', 'packages/intl/number_symbols', 'packages/intl/number_symbols_data', 'packages/intl/date_symbols'], function(dart_sdk, plural_rules, number_symbols, number_symbols_data, date_symbols) {
  'use strict';
  ...
  intl.Intl = class Intl extends core.Object {
    ...
    static canonicalizedLocale(aLocale) {
      ...
      return dart.str(aLocale[$_get](0)) + dart.str(aLocale[$_get](1)) + "_" + region;
    }
  ...
  intl.BidiFormatter = class BidiFormatter extends core.Object {
    ...
    wrapWithUnicode(text, opts) {
      ...
      if (dart.test(this.contextDirection.isDirectionChange(direction))) {
        ...
        result = marker + dart.str(text) + intl.Bidi.PDF;
      }
  ...
  intl.Bidi = class Bidi extends core.Object {
    ...
    static startsWithLtr(text, isHtml) {
      ...
      return core.RegExp.new("^[^" + "\\u0591-\\u07FF\\uFB1D-\\uFDFD\\uFE70-\\uFEFC" + "]*[" + "A-Za-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02B8\\u0300-\\u0590\\u0800-\\u1FFF\\u2C00-\\uFB1C\\uFDFE-\\uFE6F\\uFEFD-\\uFFFF" + "]").hasMatch(dart.dtest(isHtml) ? intl.Bidi.stripHtmlIfNeeded(text) : text);
    }
    static startsWithRtl(text, isHtml) {
      if (isHtml === void 0) isHtml = false;
      return core.RegExp.new("^[^" + "A-Za-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02B8\\u0300-\\u0590\\u0800-\\u1FFF\\u2C00-\\uFB1C\\uFDFE-\\uFE6F\\uFEFD-\\uFFFF" + "]*[" + "\\u0591-\\u07FF\\uFB1D-\\uFDFD\\uFE70-\\uFEFC" + "]").hasMatch(dart.dtest(isHtml) ? intl.Bidi.stripHtmlIfNeeded(text) : text);
    }
    ...
    static hasAnyLtr(text, isHtml) {
      if (isHtml === void 0) isHtml = false;
      return core.RegExp.new("[" + "A-Za-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02B8\\u0300-\\u0590\\u0800-\\u1FFF\\u2C00-\\uFB1C\\uFDFE-\\uFE6F\\uFEFD-\\uFFFF" + "]").hasMatch(dart.dtest(isHtml) ? intl.Bidi.stripHtmlIfNeeded(text) : text);
    }
    static hasAnyRtl(text, isHtml) {
      if (isHtml === void 0) isHtml = false;
      return core.RegExp.new("[" + "\\u0591-\\u07FF\\uFB1D-\\uFDFD\\uFE70-\\uFEFC" + "]").hasMatch(dart.dtest(isHtml) ? intl.Bidi.stripHtmlIfNeeded(text) : text);
    }
    ...
    static _enforceInHtmlHelper(html, direction) {
      if (html[$startsWith]("<")) {
        ...
        if (match != null) {
          ...
          buffer.write(" dir=" + dart.str(direction));
  ...
  src__intl_helpers.UninitializedLocaleData$ = dart.generic(F => {
    class UninitializedLocaleData extends core.Object {
      ...
      [_throwException]() {
        dart.throw(new src__intl_helpers.LocaleDataException.new("Locale data has not been initialized" + (", call " + dart.str(this.message) + ".")));
      }
