define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/core/application_tokens'], function(dart_sdk, change_detection, application_tokens) {
  ...
  dart.mixinMembers(Object_TouchHandler$, src__directives__control_value_accessor.TouchHandler);
  ...
  dart.mixinMembers(Object_ChangeHandler$, src__directives__control_value_accessor.ChangeHandler$(core.bool));
  ...
  dart.mixinMembers(Object_ChangeHandler$$, src__directives__control_value_accessor.ChangeHandler$(core.double));
  ...
  dart.mixinMembers(Object_TouchHandler$$0, src__directives__control_value_accessor.TouchHandler);
  ...
  dart.mixinMembers(Object_ChangeHandler$$0, src__directives__control_value_accessor.ChangeHandler);
  ...
  dart.mixinMembers(Object_TouchHandler$$1, src__directives__control_value_accessor.TouchHandler);
  ...
  dart.mixinMembers(Object_ChangeHandler$$1, src__directives__control_value_accessor.ChangeHandler$(core.String));
  ...
  src__directives__ng_control_group.NgControlGroup = class NgControlGroup extends src__directives__control_container.ControlContainer$(src__model.ControlGroup) {
    get validator() {
      return this[validator];
    }
    set validator(value) {
    ...
    get control() {
      return src__model.ControlGroup._check(this.formDirective.getControlGroup(this));
    }
    get path() {
  ...
  dart.setGetterSignature(src__directives__ng_control_group.NgControlGroup, () => ({
    ...
    control: src__model.ControlGroup,
    path: core.List$(core.String),
  ...
  src__directives__shared.composeValidators = function(validators) {
    return validators != null ? src__validators.Validators.compose(validators[$map](AbstractControlToMapOfString$dynamic(), dart.fn(src__directives__normalize_validator.normalizeValidator, dynamicToFn()))[$toList]()) : null;
  };
  ...
  dart.mixinMembers(Object_TouchHandler$$2, src__directives__control_value_accessor.TouchHandler);
  ...
  dart.mixinMembers(Object_ChangeHandler$$2, src__directives__control_value_accessor.ChangeHandler$(src__directives__radio_control_value_accessor.RadioButtonState));
  ...
  src__directives__ng_form_model.NgFormModel = class NgFormModel extends src__directives__abstract_form.AbstractForm$(src__model.ControlGroup) {
    get form() {
      return this[_form$];
    }
    set form(value) {
  ...
  src__form_builder.FormBuilder = class FormBuilder extends core.Object {
    ...
    static controlArray(controlsConfig, validator) {
      if (validator === void 0) validator = null;
      let controls = controlsConfig[$map](src__model.AbstractControl, dart.fn(src__form_builder.FormBuilder._createControl, dynamicToAbstractControl()))[$toList]();
